...
base_path = '/home/bavya/dataset/images/char-4-epoch-1/'  # windows path
...
def get_batch_data(batch_size=50, shuffle=True, epoch=15, resize_shape=None):
    """
    ...
    for i in range(epoch):
        ...
        for j in range(batch_per_epoch):
            check=_process_batch_img(files[j * batch_size:j * batch_size + batch_size], resize_shape)
            if len(check)!=0:
                yield check, \
